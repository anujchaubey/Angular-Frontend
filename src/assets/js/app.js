            ...
            for (var i = 0; i < form.length; i++) {
                ...
                switch (obj.type) {
                    case "button":
                        ...
                        button.style.cssText = " margin-left: 6px;padding: 10px 13px; display: none; border: none;box-shadow: 0 10px 20px -10px #4801FF; background-image: linear-gradient(-225deg, #AC32E4 0%, #7918F2 48%, #4801FF 100%);";
